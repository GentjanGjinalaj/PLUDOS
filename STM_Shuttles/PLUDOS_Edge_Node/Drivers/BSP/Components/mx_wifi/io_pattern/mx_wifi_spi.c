...
/* WiFi module RESET (using wakeup pin) */
#define MX_WIFI_RESET_PIN        WRLS_WKUP_W_Pin
#define MX_WIFI_RESET_PORT       WRLS_WKUP_W_GPIO_Port

/* wifi spi cs (chip select) */
#define MX_WIFI_SPI_CS_PIN       WRLS_NSS_Pin
#define MX_WIFI_SPI_CS_PORT      WRLS_NSS_GPIO_Port

/* wifi spi slave notify (data available signal) */
#define MX_WIFI_SPI_IRQ_PIN      WRLS_NOTIFY_Pin
#define MX_WIFI_SPI_IRQ_PORT     WRLS_NOTIFY_GPIO_Port
#define MX_WIFI_SPI_IRQ          WRLS_NOTIFY_EXTI_IRQn

/* wifi flow control pin */
