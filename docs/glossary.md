...
| **FL round** | One Flower federated learning round: server signals all clients to train locally, clients return model updates, server aggregates. PLUDOS default is 10 rounds (`FL_NUM_ROUNDS`, `server.py`). |
