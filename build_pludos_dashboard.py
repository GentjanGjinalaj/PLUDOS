...
panels.append(new_panel("timeseries", "Accumulated Mission Energy — live (J)",
    [ts_q("energy_j", agg="last")],
    {"h": 8, "w": 12, "x": 0, "y": y},
    fieldConfig=ts_defaults("joule", lw=2, fill=15)))

panels.append(new_panel("timeseries", "Per-Mission Energy at flush (J)",
